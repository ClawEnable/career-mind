...
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE) [![Version](https://img.shields.io/badge/version-0.5.0-green.svg)](.claude-plugin/marketplace.json)
...
| `/career-mind:cm-assess` | Assess information quality and completeness, identify gaps |
| `/career-mind:cm-craft` | Generate career artifacts: resume, performance review, promotion case, skill map |
| `/career-mind:cm-interview` | Prepare for interviews with deep-dive questions and mock practice |
