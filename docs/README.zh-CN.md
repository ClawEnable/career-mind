...
- **多场景输出** — 简历、CV、绩效评审、晋升案例、技能地图等
- **迭代质量循环** — 评估发现差距，采集自动补全

### 信任与可移植性

- **反虚构** — 每个输出要点通过 `.meta.md` 源映射追溯到已验证证据
- **零依赖** — 纯提示工程；无需构建工具、无需 API 密钥、可离线使用

### 自适应与跨平台

- **职业阶段感知** — 为应届生、职业中期、资深、转行人士适配策略
- **5+ Agent 平台** — Claude Code、Codex、Cursor、OpenCode、OpenClaw
